...
//    SupplierOrderDaoImpl supplierOrderDao = new SupplierOrderDaoImpl();
    ...
    void butAddToStockOnAction(ActionEvent event) throws SQLException {
        ...
        boolean isAdd = supplierOrderDao.addSupplierOrder(supplierOrderDto);
...
//        int qty = Integer.parseInt(txtQty.getText());
        ...
        SupplierOrderDao supplierOrderDao = new SupplierOrderDaoImpl();
        boolean isUpdate = supplierOrderDao.isUpdate(supplierOrderDto);
    ...
    private void getAllSupplierOrders() throws SQLException {
        SupplierOrderDao supplierOrderDao = new SupplierOrderDaoImpl();
        ArrayList<SupplierOrderDto> supplierOrderDtos = supplierOrderDao.getAllSupplierOrders();
