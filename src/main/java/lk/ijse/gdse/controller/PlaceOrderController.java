...
//    private StockDaoImpl stockDao = new StockDaoImpl();
    ...
    private void loadTable() throws SQLException {
        ...
        ArrayList<PlaceOrderDto> placeOrderDTOS = placeOrderDao.getAllTires();
    ...
    void butAddOnAction(ActionEvent event) throws SQLException {
        ...
        PlaceOrderDao placeOrderDao = new PlaceOrderDaoImpl();
        PlaceOrderDto placeOrderDto = placeOrderDao.getTire(tireId);
...
//        }
    ...
    void butSearchBrandOnAction(ActionEvent event) throws SQLException {
        ...
        PlaceOrderDao placeOrderDao = new PlaceOrderDaoImpl();
        ArrayList<PlaceOrderDto> placeOrderDTOS = placeOrderDao.getTireByBrand(brand);
