...
//    DiscountDaoImpl discountModel = new DiscountDaoImpl();
    ...
    void butConfirmOrderOnAction(ActionEvent event) throws SQLException {
        ...
        boolean isSaveOrder = orderDao.saveOrder(ordersDto, tireOrderDtos);
    ...
    public void addDiscount() throws SQLException {
        ...
        if (stringAmount != null){
            ...
            String discountId = discountDao.getNextDiscId();
            ...
            boolean result = discountDao.addDiscount(discountDto);
        }
    }
    ...
    void getNextPaymentId() throws SQLException {
        ConformOrderDao conformOrderDao = new ConformOrderDaoImpl();
        String paymentId = conformOrderDao.getNextPaymentId();
...
//        labBalance.setText(String.valueOf(balance));
    ...
    public void reset() throws SQLException {
        ...
        PaymentDao paymentDao = new PaymentDaoImpl();
        String paymentId = paymentDao.getNextPaymentId();
        labPaymentId.setText(paymentId);
