...
//    SupplierOrderDaoImpl supplierOrderDao = new SupplierOrderDaoImpl();
    ...
    void loadComboBoxValues() throws SQLException {
        ...
        ArrayList<String> stockId = stockDao.getAllStockId();
        ...
        ArrayList<String> supplierId = supplierDao.getAllSupplierId();
        ...
        ArrayList<String> empId = employeeDao.getAllEmployeesId();
